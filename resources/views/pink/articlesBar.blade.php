<div class="widget-first widget recent-posts">
    <h3>{{ Lang::get('ua.latest_projects') }}</h3>
            ...
            @foreach($portfolios as $portfolio)
                <div class="hentry-post group">
                    ...
                    <div class="text">
                        ...
                        <a class="read-more" href="{{ route('portfolios.show', ['alias' => $portfolio->alias]) }}">&rarr; {{ Lang::get('ua.read_more') }}</a>
                    </div>
                </div>
            @endforeach
        @endif
...
@if(!$comments->isEmpty())
    <div class="widget-last widget recent-comments">
        <h3>{{ Lang::get('ua.latest_comments') }}</h3>
